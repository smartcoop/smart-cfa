...
sed -e "s/host.docker.internal/smart-${DOCKER_NAME}_datasource_1/" \
   ./src/Smart.FA.Catalog.Web/appsettings.Development.json > ./src/Smart.FA.Catalog.Web/appsettings.DevelopmentTmp.json
mv ./src/Smart.FA.Catalog.Web/appsettings.DevelopmentTmp.json ./src/Smart.FA.Catalog.Web/appsettings.Development.json

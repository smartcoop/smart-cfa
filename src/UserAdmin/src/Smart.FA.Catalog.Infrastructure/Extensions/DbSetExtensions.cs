...
{
    /// <summary>
    /// Retrieves the last created  <see cref="IEntity" /> or if the list is empty, its default value.
    /// </summary>
    ...
    public static async Task<TEntity?> GetLatestOrDefault<TEntity>(this DbSet<TEntity> entityDbSet, CancellationToken cancellationToken = default) where TEntity : Entity

...
/// <summary>
/// Test Trainer Inquiry mail service with a redirect on a mail address used for debugging and general testing.
/// </summary>
public class TrainerInquirySendEmailWithTestRedirectService : InquiryEmailServiceBase<TrainerInquirySendEmailRequest, TrainerInquirySendEmailTemplateModel>, ITrainerInquirySendEmailService
{
    ...
    public TrainerInquirySendEmailWithTestRedirectService(
        ILogger<TrainerInquirySendEmailWithTestRedirectService> logger,
        IServiceProvider serviceProvider,
        IFluentEmail fluentEmail,
        IMemoryCache memoryCache,
        IOptions<FluentEmailOptions> fluentEmailOptions,
        IOptions<TestInquiryOptions> inquiryOptions) : base(logger, fluentEmail, memoryCache)
    {
        _serviceProvider = serviceProvider;
        _fluentEmailSettings = fluentEmailOptions.Value;
        _testInquirySettings = inquiryOptions.Value;
    }
    ...
    protected override int GetRateLimitInSeconds() => _testInquirySettings.RateLimitInSeconds;

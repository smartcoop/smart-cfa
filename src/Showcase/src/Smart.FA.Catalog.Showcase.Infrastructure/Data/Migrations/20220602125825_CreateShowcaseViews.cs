...
{
    public partial class CreateShowcaseViews : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // TrainerDetails.
            migrationBuilder.Sql("DROP VIEW IF EXISTS Cfa.V_TrainerDetails");
            ...
            // TrainerList.
            migrationBuilder.Sql("DROP VIEW IF EXISTS Cfa.V_TrainerList");
            migrationBuilder.Sql(@"
            ...
            // TrainingDetails.
            migrationBuilder.Sql("DROP VIEW IF EXISTS [Cfa].[v_TrainingDetails]");
            migrationBuilder.Sql(@"

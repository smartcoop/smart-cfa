...
AS
SELECT training.Id, detail.Title, detail.Methodology, detail.Goal, detail.PracticalModalities, category.TrainingTopicId, detail.Language, trainer.FirstName,
trainer.LastName,trainer.Title AS trainerTitle, training.StatusId

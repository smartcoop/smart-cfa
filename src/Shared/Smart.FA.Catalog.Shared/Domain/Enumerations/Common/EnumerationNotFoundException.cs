...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EnumerationNotFoundException"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EnumerationNotFoundException"/> class with serialized data.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EnumerationNotFoundException"/> class with a specified error message.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EnumerationNotFoundException"/> class with a specified error message and
